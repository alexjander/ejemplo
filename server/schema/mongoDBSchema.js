...
const typeDefs = `
  ...
  type Mutation {
    ...
    addTiposdocu_M(descripcion:String!,codigo:String!): Tiposdocu  
...
const resolvers = {
  Query: {
    ...
    getTiposdocuCode_Q: (_, args, context) => getTiposdocuCode_R(context, args, ["admin", "owner", "dummy"], getTiposdocuCode_C),
  ...
  Mutation: {
    ...
    addTiposdocu_M: (_, args, context) => addTiposdocu_R(args, addTiposdocu_C), // first time user is created see - connector where a dummy role is inserted
